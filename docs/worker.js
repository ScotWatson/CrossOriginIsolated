...
import("https://scotwatson.github.io/Queue/Queue.mjs").then(function (Queue) {
  try {
    ...
    self.addEventListener("message", function (evt) {
      ...
      console.log("received type: " + evt.data.type);
    ...
    setTimeout(function () {
      ...
      for (let i = 0; i < 0x10; ++i) {
        console.log("worker.js receivedQueueDequeueView[0x" + i.toString(16).padStart("0", 2) + "]: 0x" + receivedQueueDequeueView[i].toString(16).padStart("0", 2));
      }
    }, 1500);
  } catch (e) {
    console.error(e);
